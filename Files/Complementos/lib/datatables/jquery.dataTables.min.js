...
(function(h, V, l, m) {
    var j = function(e) {
            ...
            for (f = 0, j = c.length; f < j; f++)
                for (g = 0, n = c[f].childNodes.length; g < n; g++)
                    if (d = c[f].childNodes[g], "TD" == d.nodeName.toUpperCase() || "TH" == d.nodeName.toUpperCase()) {
                        ...
                        for (e = 0; e < k; e++)
                            for (i = 0; i < m; i++)
                                a[f + i][o + e] = {cell: d, unique: 1 == k ? !0 : !1}, a[f + i].nTr = c[f]
                    }
        }
        function O(a, b, c) {
            var d = [];
        ...
        function Ea(a) {
            ...
            c.push({name: "iDisplayLength", value: !1 !== a.oFeatures.bPaginate ?
                        a._iDisplayLength : -1});
            for (g = 0; g < b; g++)
                d = a.aoColumns[g].mDataProp, c.push({name: "mDataProp_" + g, value: "function" === typeof d ? "function" : d});
            if (!1 !== a.oFeatures.bFilter) {
                ...
                for (g = 0; g < b; g++)
                    c.push({name: "sSearch_" + g, value: a.aoPreSearchCols[g].sSearch}), c.push({name: "bRegex_" + g, value: a.aoPreSearchCols[g].bRegex}), c.push({name: "bSearchable_" + g, value: a.aoColumns[g].bSearchable})
            }
            if (!1 !== a.oFeatures.bSort) {
                ...
                for (g = 0; g < d.length; g++) {
                    ...
                    for (i = 0; i < f.length; i++)
                        c.push({name: "iSortCol_" + e, value: f[i]}), c.push({name: "sSortDir_" + e, value: d[g][1]}), e++
                }
                c.push({name: "iSortingCols", value: e});
                for (g = 0; g < b; g++)
                    c.push({name: "bSortable_" + g, value: a.aoColumns[g].bSortable})
            }
            return c
        }
        function ia(a, b) {
        ...
        function Ca(a) {
            ...
            if (!a.aanFeatures.i)
                a.aoDrawCallback.push({fn: Ja, sName: "information"}), b.id = a.sTableId + "_info";
                ...
                if (c) {
                    ...
                    if (-1 === h.inArray(!1, d)) {
                        ...
                        for (d = 0; d < c.abVisCols.length; d++)
                            b.saved_aoColumns[d] = {}, b.saved_aoColumns[d].bVisible =
                                    c.abVisCols[d];
        ...
        this.fnFilter = function(a, b, c, d, f, g) {
            ...
            if (e.oFeatures.bFilter) {
                ...
                if (b === m || null === b) {
                    ...
                    h.extend(e.aoPreSearchCols[b], {sSearch: a + "", bRegex: c, bSmart: d, bCaseInsensitive: g}), M(e, e.oPreviousSearch, 1)
            }
        };
        this.fnGetData =
                function(a, b) {
    ...
    j.defaults = {aaData: null, aaSorting: [[0, "asc"]], aaSortingFixed: null, aLengthMenu: [10, 25, 50, 100], aoColumns: null, aoColumnDefs: null, aoSearchCols: [],
...
$.fn.dataTableExt.oApi.fnPagingInfo = function(b) {
    return{iStart: b._iDisplayStart, iEnd: b.fnDisplayEnd(), iLength: b._iDisplayLength, iTotal: b.fnRecordsTotal(), iFilteredTotal: b.fnRecordsDisplay(), iPage: Math.ceil(b._iDisplayStart / b._iDisplayLength), iTotalPages: Math.ceil(b.fnRecordsDisplay() / b._iDisplayLength)}
};
$.extend($.fn.dataTableExt.oPagination, {bootstrap: {fnInit: function(b, e, c) {
            var d = b.oLanguage.oPaginate, a = function(a) {
                a.preventDefault();
            ...
            e = $("a", e);
            $(e[0]).bind("click.DT", {action: "previous"}, a);
            $(e[1]).bind("click.DT", {action: "next"}, a)
        }, fnUpdate: function(b, e) {
            var c = b.oInstance.fnPagingInfo(), d = b.aanFeatures.p, a, g, i, f, h;
            a = Math.floor(2.5);
            ...
            for (iLen = d.length; a < iLen; a++) {
                ...
                for (g = f; g <= h; g++)
                    i = g == c.iPage + 1 ? 'class="active"' : "", $("<li " + i + '><a href="#">' + g + "</a></li>").insertBefore($("li:last", d[a])[0]).bind("click", function(a) {
                        a.preventDefault();
...
$.extend($.fn.dataTableExt.oPagination, {bootstrap_alt: {fnInit: function(d, e, b) {
            ...
            $(e).addClass("pagination").append('<ul><li class="first disabled"><a href="#">&lt;&lt; ' + c.sFirst + '</a></li><li class="prev disabled"><a href="#">&lt; ' + c.sPrevious + '</a></li><li class="next disabled"><a href="#">' + c.sNext + ' &gt;</a></li><li class="last disabled"><a href="#">' + c.sLast + " &gt;&gt;</a></li></ul>");
            e = $("a", e);
            ...
            for (iLen = c.length; a < iLen; a++) {
                ...
                var j = $(c[a]).find(".next");
                for (g = f; g <= h; g++)
                    i = g == b.iPage + 1 ? 'class="active"' : "", $("<li " + i + '><a href="#">' + g + "</a></li>").insertBefore(j).bind("click", function(a) {
                        a.preventDefault();
