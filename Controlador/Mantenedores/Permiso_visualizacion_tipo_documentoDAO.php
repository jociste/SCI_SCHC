...
class Permiso_visualizacion_tipo_documentoDAO {
    ...
    public function deleteIdTipoDocumento($idTipoDocumento) {
        $this->conexion->conectar();
        $query = "DELETE FROM permiso_visualizacion_tipo_documento WHERE  idTipoDocumento =  " . $idTipoDocumento . " ";
        $result = $this->conexion->ejecutar($query);
        $this->conexion->desconectar();
        return $result;
    }
    ...
    public function findByIdTipoDocumento($idTipoDocumento) {
        $this->conexion->conectar();
        $query = "SELECT * FROM permiso_visualizacion_tipo_documento WHERE  idTipoDocumento =  " . $idTipoDocumento . " ";
        $result = $this->conexion->ejecutar($query);
        $i = 0;
        $permiso_visualizacion_tipo_documentos = array();
        while ($fila = $result->fetch_row()) {
