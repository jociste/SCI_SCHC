...
if (isset($_REQUEST['sinFechasProductosUsados'])) {
    ...
    $lote_productos = $control->getAllLote_productos_usados_by_fechas($fechaInicio, $fechaTermino);
}
...
<html>
    ...
    <body>
        <div>
            <table class="table">
                <tr><th align="center"><h5>REPORTE<br>PRODUCTOS UTILIZADOS</h5></th></tr>
            </table>
        </div>
        <div>
            <table class="table">
        ...
        <div>
            <table class="table">
                <tr><td class="td-borde alto-xm ancho-71mm" colspan="8">4.- DETALLE DE PRODUCTOS UTILIZADOS</td></tr>                
                <tr><td class="td-borde fondo ancho-23mm" align="center" valign="top">Fecha Retiro</td><td class="td-borde fondo ancho-56mm" align="center" valign="top">Destino</td><td class="td-borde fondo ancho-32mm" align="center" valign="top">Retirado Por</td><td class="td-borde fondo ancho-43mm" align="center" valign="top">Nombre Producto</td><td class="td-borde fondo ancho-43mm" align="center" valign="top">Cantidad</td></tr>
                <?php
                $count = 0;
                foreach ($lote_productos as $producto) {                    
                    echo '<tr><td class="td-borde alto-xs">' . $producto->getFechaRetiro() . '</td><td class="td-borde alto-xs">' . $producto->getDestino() . '</td><td class="td-borde alto-xs">' . $producto->getNombres() . '</td><td class="td-borde alto-xs center">' . $producto->getNombreProducto() . '</td><td class="td-borde alto-xs right">' . $producto->getCantidad() . '</td></tr>';
                    $count++;
                }
                if ($count < 36) {
                    $resto = 36 - $count;
                    for ($i = 0; $i < $resto; $i++) {
                        echo '<tr><td class="td-borde alto-xs"></td><td class="td-borde alto-xs"></td><td class="td-borde alto-xs"></td><td class="td-borde alto-xs"></td><td class="td-borde alto-xs"></td></tr>';
                    }
                }
                ?>
            </table>
