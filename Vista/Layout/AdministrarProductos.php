                ...
                <div class="row-fluid">
                    ...
                    <div id="content" class="span9" >
                        ...
                        <div class="row-fluid">
                            ...
                            <?php
                            if ($perfil == 1) {
                                include '../Menus/directoraVisualizaProductos.php';
                            }
                            if ($perfil == 4) {
                                include '../Menus/auxiliarVisualizaProductos.php';
                            }
                            ?>
                ...
                $.getJSON(
                        ...
                        function (datos) {
                            $.each(datos, function (k, v) {
                                ...
                                contenido += "</td>";
                                contenido += "</tr>";
                                $("#tablaProductos").append(contenido);
                            });
                        }
                );
            }
            function cargarAuxiliar() {
                $("#tablaProductosAuxiliar").empty();
                ...
                $.getJSON(
                        ...
                        function (datos) {
                            $.each(datos, function (k, v) {
                                ...
                                contenido += "</td>";
                                contenido += "</tr>";
                                $("#tablaProductosAuxiliar").append(contenido);
                            });
                        }
                );
            }
