...
<html>
    ...
    <body>
        <div>
            <table class="table">
                <tr><th align="center"><h5>REPORTE<br>PRODUCTOS POR VENCER</h5></th></tr>
            </table>
        </div>
        <div>
            <table class="table">
        ...
        <div>
            <table class="table">
                <tr><td class="td-borde alto-xm ancho-71mm" colspan="8">4.- DETALLE DE PRODUCTOS POR VENCER</td></tr>                
                <tr><td class="td-borde fondo ancho-32mm" align="center" valign="top">Fecha Vencimiento</td><td class="td-borde fondo ancho-100mm" align="center" valign="top">Producto</td><td class="td-borde fondo ancho-32mm" align="center" valign="top">Cantidad</td><td class="td-borde fondo ancho-32mm" align="center" valign="top">Estado</td></tr>
                <?php
                $count = 0;
