...
<html>
    ...
    <body>
        <div>
            <table class="table">
                <tr><th align="center"><h5>REPORTE<br>PRODUCTOS BAJO STOCK</h5></th></tr>
            </table>
        </div>
        <div>
            <table class="table">
        ...
        <div>
            <table class="table">
                <tr><td class="td-borde alto-xm ancho-71mm" colspan="8">4.- DETALLE DE PRODUCTOS BAJO STOCK</td></tr>                
                <tr><td class="td-borde fondo ancho-23mm" align="center" valign="top">Cantidad</td><td class="td-borde fondo ancho-100mm" align="center" valign="top">Producto</td><td class="td-borde fondo ancho-32mm" align="center" valign="top">Fecha Ingreso</td><td class="td-borde fondo ancho-43mm" align="center" valign="top">Estado</td></tr>
                <?php
                $count = 0;
                foreach ($lote_productos as $producto) {
                    $estado = "";
                    if ($producto->getCantidad() == 0) {
                        $estado = "<b>Sin Existencias</b>";
                    } else {
                        if ($producto->getCantidad() <= 5) {
                            $estado = "<b>Menor a 5 unidades</b>";
                        } else {
                            $estado = "<b>Menor a 11 unidades</b>";
                        }
                    }
                    echo '<tr><td class="td-borde alto-xs right">' . $producto->getCantidad() . '</td><td class="td-borde alto-xs">' . $producto->getNombre() . '</td><td class="td-borde alto-xs">' . $producto->getFechaIngreso() . '</td><td class="td-borde alto-xs center">' . $estado . '</td></tr>';
                    $count++;
                }
                if ($count < 36) {
                    $resto = 36 - $count;
