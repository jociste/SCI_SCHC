...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8">
        <title>Universal Admin Dashboard theme | FORMS</title>
        ...
        <div class="navbar  navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container-fluid">
                    ...
                    <img src="img/logo_small.png" class="pull-left nav_logo">
                    ...
                    <div class="nav-collapse collapse header-nav">
                        ...
                        <ul class="nav  pull-right">
                            ...
                            <li class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                    <img  width="27" height="27"  class="img-circle" src="img/shaan.png" >     Hello Shawn
                                </a>
                                <ul class="dropdown-menu">
        ...
        <div class="wrap">
            <div class="container-fluid">
                <div class="row-fluid">
                    ...
                    <div class="span9 text-center">
                        <form class="">
                            <div class="input-prepend input-append">
                                <div class="btn-group">
                                    <button class="btn btn-inverse dropdown-toggle" data-toggle="dropdown"><i class="icon-list-alt"></i> Options <span class="caret"></span></button>
                                    <ul class="dropdown-menu">
                                ...
                                <input class="input-block-level search-above" placeholder="Search universal big data . . ." id="appendedPrependedDropdownButton" type="text">
                    ...
                    <div class="span3">
                        <ul class="top-profile-list pull-left">
                            <li>
                                <p class="text-center">
