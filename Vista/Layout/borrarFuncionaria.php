                                        ...
                                        <div class="row-fluid">
                                            ...
                                            <form id="fm-Funcionaria" class="form-horizontal well">
                                                ...
                                                <div class="form-actions" style="height: 30px;">
                                                    <h4 style="width: 200px; align-content: center; margin: 0; padding-left: 30%">Borrar Funcionaria</h4> 
                                                </div>                                                                                               
                                                ...
                                                <div class="form-actions" style="align-content: center">
                                                    <button type="button" onclick="borrarFuncionaria()" class="btn btn-primary">Borrar Funcionaria</button>
