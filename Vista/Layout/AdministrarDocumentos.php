...
//                    }
    ...
    <script>
                                            ...
                                            function buscar() {
                                                ...
                                                $.getJSON(
                                                        ...
                                                        function (datos) {
                                                            ...
                                                            $.each(datos, function (k, v) {
                                                                obtenerImagenExtension(v.rutaDocumento)
                                                                ...
                                                                var contenido = "<div class='media well-small'>"
                                                                        + "<a class='pull-left' href='" + v.rutaDocumento + "'><img class='media-object' data-src='holder.js/120x120' alt='120x120' src='../../Files/img/pdf.png'></a>"
                                                                        + "<div class='media-body'>"
                                            ...
                                            function obtenerImagenExtension(ruta) {
                                                var res = ruta.split("/");
                                                var nombre = res[res.length - 1].split(".");
