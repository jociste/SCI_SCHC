...
<!--            <div class="container-fluid">
                <div class="row-fluid">
                    <div id="content" class="span9" style="width: 500px; align-content: center">   -->
                        <div class="row-fluid" style="align-content: center">
                            <div class="span12" style="align-content: center" >
                                <div class="row-fluid" style="align-content: center">
                                    <form id="fm-Categoria" class="form-horizontal well" style="align-content: center ;background-color: #ffd5d5">
                                        ...
                                        <hr>
                                        <div class="" style="padding-left: 30%; align-content: center">
